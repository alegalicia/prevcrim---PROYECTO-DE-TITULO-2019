...
if ($ingresar == "ok") {
    ...
    echo "<meta http-equiv='refresh' content='0;url=../view/op_atecedentes.php'>";
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <body>
        <center>
            ...
            <div class="col-md-10 login-sec">
                <form class="login-form" action="op_atecedentes.php" method="post" name="f1">
            ...
            <form class="login-form" action="op_atecedentes.php" method="post" name="f2">
