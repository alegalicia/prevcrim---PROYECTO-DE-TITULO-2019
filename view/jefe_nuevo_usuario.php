...
if($clave==$clave1){
        ...
        if ($ingresar == "crear")
        {
            ...
            $registrar = $ingresar_act->ingresar_usuario($primer_nombre, $segundo_nombre, $primer_apellido, $segundo_apellido, 
            $correo, $celular, $fijo, $comuna, $institucion, $perfil, $clave, $direccion, $rut);
           echo "<meta http-equiv='refresh' content='0;url=../view/jefe_nuevo_usuario.php'>";
        }
...
<body>
 <center>
    <h3>Nuevo usuairo <p>(Solo puede crear Operarios de su misma Insitutción)</p></h3>
    <div class="container">
        <br>
...
<?php
   }else echo"debe iniciar sesión con una cuenta con previlegios asd";
?>
