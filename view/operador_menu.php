      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="op_atecedentes.php" target='cen'><i class="fa fa-id-card-o"></i>Atecedentes</a></li>
            <li><a href="op_busqueda.php" target='cen'><i class="fa fa-id-card-o"></i>Busqueda general</a></li>
