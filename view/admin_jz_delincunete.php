   ...
   require_once '../controller/cadmin.php';
    ...
    $ingresar              = isset($_REQUEST['ingresar'])?$_REQUEST['ingresar']:isset($_REQUEST['ingresar']);
        ...
        if ($ingresar == "crear")
        {
            ...
            $registrar = $ingresar_delincuente->nuevo_delincuente($primer_nombre, $segundo_nombre, $primer_apellido, $segundo_apellido, $celular, $fijo, $rut, $comuna, $nacionalidad, $direccion, $genero, $id_estado_delincuente,  $ingresar, $apado);
                ...
                <form method="post">
                    <div class="container">
                        <table class="table table-striped">
                            <form class="well form-horizontal" method="post" action="admin_jz_delincunete.php">
                                <tbody>
                                   ...
                                   <tr>
                                        ...
                                        <td colspan="1">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 inputGroupContainer">
                                                    <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span><input name="primer_nombre" placeholder="Primer Nombre" class="form-control" required="true" type="text" maxlength="20"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 inputGroupContainer">
                                                    <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span><input name="primer_apellido" placeholder="Primer Apellido" class="form-control" required="true" type="text" maxlength="20"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 inputGroupContainer">
                                                    <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span><input name="apodo" placeholder="Apodo" class="form-control" required="true" type="text" maxlength="20"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 inputGroupContainer">
                                                    <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span><input name="direccion" placeholder="Domicilio" class="form-control" required="true"  type="text" maxlength="20"></div>
                                                </div>
                                            </div>
                                        ...
                                        <td colspan="1">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 inputGroupContainer">
                                                    <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span><input name="segundo_nombre" placeholder="Segundo Nombre" class="form-control" required="true" value="" type="text" maxlength="20"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 inputGroupContainer">
                                                    <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span><input name="segundo_apellido" placeholder="Segundo Apellido" class="form-control" required="true" value="" type="text" maxlength="20"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 inputGroupContainer">
                                                    <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span><input name="celular" placeholder="Celuar" class="form-control" required="true" type="text" maxlength="9" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 inputGroupContainer">
                                                    <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span><input name="fijo" placeholder="Fijo" class="form-control" required="true" type="text" maxlength="9" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 inputGroupContainer" id="div1">
                                                <div class="input-group">
                                                    <span class="input-group-addon" style="max-width: 100%;"><i class="glyphicon glyphicon-list" name="estado"></i></span>
                                    ...
                                    <td align="center" colspan="2">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-success" name="ingresar" value="crear">Ingresar Delincuente</button>
                                        </div>
                                    </td>
