...
if(!isset($_SESSION["login"])){session_start(); } 
 ...
 if ($ingresar == "actualizar"){   
     if($clave==$clave1){      
         if($comuna != 0){
                        $act = new funciones();
                        $registrar = $act->actualizar_usuario_ins($primer_nombre, $segundo_nombre, $primer_apellido , $segundo_apellido, $correo,
...
<body>
   <?php  $ins = $_SESSION["institucion"]; ?>
    <center>
        <br>
        <h3> Actualizar Usuarios de la institucón <l> <?php echo $ins; ?> </l>: </h3>
        <div class="col-md-8 login-sec">
            <form class="login-form" action="admin_jz_actualizar.php" method="post" name="f1">
              ...
              { $fac = $o['rut'];
                  ?>
                        <tr>
                            ...
                            <td id="ins"><?php echo $o['institucion']?></td>
                        </tr>
                        <?php
                            }
                        ?>
 ...
 //==================LISTA DE comunas =============       
    ...
    <div class="card bg-light">
            <article class="card-body mx-auto" style="max-width: 400px;">
                <form action="admin_jz_actualizar.php" method="get">
